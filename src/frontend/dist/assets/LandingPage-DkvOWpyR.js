import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, B as Badge, L as Link, a as Button, S as Separator, M as MapPin, U as Users, b as BookOpen, d as Briefcase, G as GraduationCap, e as Building2 } from "./index-BFdoklgf.js";
...
import { S as Shield } from "./shield-CtdRQXFK.js";
/**
...
const leaders = [
  ...
  },
  {
    ...
    quoteEn: "Skill development and job creation are at the center of our agenda.",
  ...
  },
  {
    ...
    quoteEn: "A prosperous Chhattisgarh will be built through education and self-employment.",
...
const modules = [
  {
    ...
    description: "Hands-on technical training across digital skills, computer literacy, and industry certifications.",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { size: 24 })
  },
  {
    id: "motivational",
    ...
    description: "Inspiring sessions with industry leaders and mentors to ignite ambition and build confidence.",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Lightbulb, { size: 24 })
  },
  {
    id: "placement",
    ...
    description: "Direct campus recruitment drives connecting youth with top employers across Chhattisgarh.",
  ...
  },
  {
    ...
    description: "Competitive exam preparation and subject-specific coaching for government and private sector jobs.",
  ...
  },
  {
    ...
    description: "Micro, Small & Medium Enterprise support for aspiring entrepreneurs with funding guidance.",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { size: 24 })
  },
  {
    id: "nasha",
    title: "Nasha Mukti",
    ...
    description: "Anti-drug awareness initiatives and rehabilitation support for healthier communities.",
...
const highlights = [
  { label: "Chhattisgarh-wide program network", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 14 }) },
  {
    label: "Direct placement partnerships with industries",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { size: 14 })
  },
  { label: "Free enrollment for eligible youth", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 14 }) },
  { label: "Government-backed certification", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 14 }) }
];
const footerLinks = [
...
function SectionHeading({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 text-center", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        style: {
          background: "linear-gradient(135deg, #d44f00 0%, #FF6B35 40%, #ff8c42 70%, #ffad60 100%)"
        },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                backgroundImage: "url('/assets/generated/hero-hhk-banner.dim_1400x500.jpg')"
              },
              "aria-hidden": "true"
            }
          ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    ...
                    children: "Shree Raipur Cement Plant — CSR Initiative"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h1",
                  {
                    ...
                    children: "हम होंगे कामयाब"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/90 font-display text-xl md:text-2xl mb-2 font-medium", children: "युवाओं के सपनों को उड़ान देना" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/75 text-base md:text-lg mb-10 font-body", children: "Shree Raipur Cement Plant — CSR Career Development Program" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-center", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      onClick: () => {
                        var _a;
                        return (_a = document.getElementById("programs-section")) == null ? void 0 : _a.scrollIntoView({ behavior: "smooth" });
                      },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-12 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "svg",
            {
              viewBox: "0 0 1440 48",
              fill: "none",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background py-16", "data-ocid": "leadership-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SectionHeading,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: leaders.map((leader, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "card-elevated text-center overflow-hidden hover:shadow-md transition-smooth", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-1.5 bg-gradient-to-r ${leader.color}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-8 pb-6 px-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `w-20 h-20 rounded-full bg-gradient-to-br ${leader.color} mx-auto mb-4 flex items-center justify-center shadow-md`,
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-display font-bold text-2xl", children: leader.initial })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-base mb-0.5", children: leader.nameHindi }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body mb-1", children: leader.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs mb-4 px-2", children: leader.titleHindi }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "mb-4" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-primary font-body italic leading-relaxed mb-1", children: leader.quote }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: leader.quoteEn })
            ] })
          ] })
        },
        leader.name
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-muted/30 border-y border-border py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          viewport: { once: true },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body uppercase tracking-widest text-primary mb-2", children: "About the Program" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl font-display font-bold text-foreground mb-4 leading-tight", children: [
              "Hum Honge Kamyab —",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "हम होंगे कामयाब" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4 font-body", children: "A flagship CSR initiative by Shree Raipur Cement Plant, dedicated to empowering the youth of Chhattisgarh through skill development, career guidance, and direct placement support." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-8 font-body", children: "We bridge the gap between talent and opportunity — offering free courses, motivational workshops, placement camps, and government-backed certification programs across the region." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-4 mb-8", children: stats.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "text-center p-3 rounded-md bg-card border border-border shadow-sm",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center text-primary mb-1", children: stat.icon }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-display font-bold text-primary", children: stat.value }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-tight mt-0.5", children: stat.labelHindi }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground/70", children: stat.label })
                ]
              },
              stat.label
            )) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "card-elevated overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 bg-gradient-to-r from-primary to-amber-500" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-8", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-lg mb-1", children: "Program Highlights" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-6", children: "कार्यक्रम की विशेषताएं" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-4 mb-6", children: highlights.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-7 h-7 rounded-full bg-primary/10 flex items-center justify-center text-primary shrink-0", children: h.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-foreground font-body", children: h.label })
              ] }, h.label)) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "mb-6" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 p-4 bg-primary/5 rounded-md border border-primary/15", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-primary flex items-center justify-center shrink-0 mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 14, className: "text-white" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-sm text-foreground mb-0.5", children: "Shree Raipur Cement — CSR Commitment" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: "Investing in communities through sustainable skills development and meaningful employment since 2018." })
                ] })
              ] })
            ] })
          ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5", children: modules.map((mod, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Card,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-primary/10 group-hover:bg-primary group-hover:text-white rounded-lg flex items-center justify-center text-primary mb-4 transition-smooth shrink-0", children: mod.icon }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-base mb-0.5", children: mod.titleHindi }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-primary font-body mb-2 font-semibold", children: mod.subtitle }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: mod.description }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center gap-1 text-primary text-xs font-semibold opacity-0 group-hover:opacity-100 transition-smooth", children: [
                      "Learn More ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body uppercase tracking-widest text-primary mb-1", children: "Upcoming Jobs" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-display font-bold text-foreground leading-tight", children: "रोजगार के अवसर" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 w-16 h-1 bg-primary rounded-full" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/jobseeker/jobs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                variant: "outline",
                size: "sm",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: jobs.map((job, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-8 rounded-full bg-primary/10 text-primary font-display font-bold text-sm flex items-center justify-center shrink-0 mt-0.5", children: job.num }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-sm", children: job.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 mt-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-body", children: job.company }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 ml-12 sm:ml-0 shrink-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground hidden sm:block", children: [
                    "Closes: ",
                    job.closing
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs", children: job.type }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background py-16", "data-ocid": "schemes-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SectionHeading,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: schemes.map((scheme, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-8 rounded-full bg-primary text-primary-foreground text-sm font-display font-bold flex items-center justify-center shrink-0 mt-0.5", children: i + 1 }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-sm mb-0.5", children: scheme.nameHindi }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-1", children: scheme.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: scheme.desc })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ExternalLink,
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        style: {
          background: "linear-gradient(135deg, #c43d00 0%, #FF6B35 50%, #ff9a5c 100%)"
        },
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              viewport: { once: true },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 uppercase tracking-widest text-sm font-body mb-3", children: "Join the Movement" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    className: "font-display font-bold text-white leading-tight mb-3",
                    style: { fontSize: "clamp(2rem, 5vw, 3.5rem)" },
                    children: "अपने आप को रजिस्टर करें"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/85 text-xl font-display font-semibold mb-2", children: "Register Yourself for Free Career Development" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/65 text-base font-body mb-10", children: "Join thousands of youth already on the path to success — हम होंगे कामयाब" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/signup", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    size: "lg",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-10 mb-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-primary flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-display font-bold text-sm", children: "HHK" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-background text-sm leading-tight", children: "हम होंगे कामयाब" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-background/50 text-xs", children: "Hum Honge Kamyaab" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-background/60 text-sm leading-relaxed font-body mb-4", children: "A CSR initiative by Shree Raipur Cement Plant empowering the youth of Chhattisgarh since 2018." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: [
                ...
                "a",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { size: 14, className: "text-background" })
                },
                label
              )) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-bold text-background text-sm mb-4 uppercase tracking-wide", children: "Quick Links" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: footerLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Link,
                {
                  to: link.path,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-bold text-background text-sm mb-4 uppercase tracking-wide", children: "Contact Us" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 14, className: "text-primary mt-0.5 shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-background/60 font-body leading-relaxed", children: "Shree Raipur Cement Plant, NH-30, Raipur, Chhattisgarh — 493221" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 14, className: "text-primary shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-background/60 font-body", children: "+91 771 250 0000" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 14, className: "text-primary shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-background/60 font-body", children: "csr@shreecementlimited.com" })
                ] })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "bg-background/10 mb-6" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-background/40", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "© ",
              (/* @__PURE__ */ new Date()).getFullYear(),
              " Hum Honge Kamyaab — Shree Raipur Cement Plant CSR Initiative. All rights reserved."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
